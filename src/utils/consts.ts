import {ChainId, getEmitterAddressEth, getEmitterAddressSolana, getEmitterAddressTerra,} from "@certusone/wormhole-sdk";
...
export const LAUNCH_DATE = DateTime.fromISO("2021-09-13T00:00:00.000+00:00");

const defaultInterval: AxisInterval = "preserveStartEnd"
export const TIME_FRAMES: { [key: string]: TimeFrame } = {
  ...
  "All time": {
    ...
    duration: Duration.fromObject({
      days: Math.floor(DateTime.now().diff(LAUNCH_DATE).as("days"))
    }),
    tickFormatter: monthFormatter
  },
};
